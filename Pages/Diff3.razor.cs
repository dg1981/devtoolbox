...
{
    public interface IDiff3VM : IViewModel
    {
       
    }

    public class Diff3VM : ViewModel, IDiff3VM
    {
        public Diff3VM(IJSRuntime jsRunTime, ProtectedLocalStorage protectedLocalStorage, ClipboardService clipboard, IWebHostEnvironment hostingEnvironment)
